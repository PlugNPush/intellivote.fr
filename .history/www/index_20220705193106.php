                  ...
                  <div class="alert alert-info fade show" role="alert"';
                    ...
                    */
                    ...
                    while ($election=$getdates->fetch()){ //case 1 or many ongoing elections 
                      ...
                      //date('jS F Y à H:i:s', strtotime($election["enddate"]))
                      //date('d %B Y à H:i', strtotime($election["enddate"]))
                      //,strftime('%d %B %Y à %H:%M', strtotime($election["enddate"])),
                    //  $old_date_timestamp = strtotime($election["enddate"]);
                        $date2 = str_replace('/', '-', $election["enddate"]);
                        ...
                        if (!isset($_POST["monVote".$election['id']])){ // if elector hasnt voted yet and hasn't selected a candidate
                            ...
                            echo '
                              ...
                              <br>
                              <p>L\'élection prend fin le : ',date_format($election["enddate"], 'd/m/Y H:i:s'),' heures.</p>
                            </div>';
                          }   
