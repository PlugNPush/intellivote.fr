                ...
                echo '
                  ...
                  $indiv = $req->fetch();
                    ...
                    echo '<div class="form-group">
                      ...
                      - Id de l\'employé de la mairie : ';echo($_GET['individual']);echo(' | Nom : '.$individual['surname'].' Prénom : '.$individual['name']);
                      echo '<br> - ID de la mairie : ';echo($_GET['idmairie']);;echo(' | Nom : '.$mairie['nom']);
                      echo'</label>
