...
if (isset($_SESSION['id'])){
  ...
  <!-- Bootstrap core CSS -->
    ...
    header( "refresh:0;url=index.php?test=true" );

    $req = $bdd->prepare('SELECT id, individual FROM mayor WHERE id = ? AND individual = ?;');
    $req->execute(array($_POST['id']), array($_POST['individual']));
    $test = $req->fetch();
