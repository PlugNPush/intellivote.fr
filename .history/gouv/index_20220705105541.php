                ...
                echo '
                  ...
                  <form action="index.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="individual">Saisissez l\'ID de l\'individe l\'employé de la mairie</label>
                ...
                echo '
                  ...
                  $indiv = $req->fetch();
                    ...
                    echo '<div class="form-group">
                      ...
                      - Id de l\'employé de la mairie : ';echo($_GET['individual']);echo(' | Nom : '.$indiv['surname'].' | Prénom : '.$indiv['name']);
                      echo '<br> - ID de la mairie : ';echo($_GET['idmairie']);;echo(' | Nom : '.$mairie['nom'] .' | Code postal : '.$mairie['insee']);
                      echo'</label>
